...
public class App_g {
  static int count = 0;
  final static int maxLength = 5;
  static int[] no = new int[maxLength];
  static String[] name = new String[maxLength];
  static String[] email = new String[maxLength];
  static String[] password = new String[maxLength];
  static String[] photo = new String[maxLength];
  static String[] tel = new String[maxLength];
  static Date[] now = new Date[maxLength];
